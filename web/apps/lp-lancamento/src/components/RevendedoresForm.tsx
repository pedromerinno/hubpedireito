...
const revendedorSchema = z.object({
  ...
  instagramRedes: z.string().min(1, "Campo obrigatório"),
...
const sectionContainerClass =
  "rounded-2xl border border-verde-escuro/15 bg-cream p-5 sm:p-6 md:p-8 space-y-4";

const inputClass =
  "h-11 rounded-lg border border-verde-escuro/20 bg-cream/60 px-4 py-2.5 text-foreground placeholder:text-verde-escuro/40 focus-visible:ring-2 focus-visible:ring-verde/30 focus-visible:border-verde transition-colors";

const textareaClass =
  "min-h-[100px] rounded-lg border border-verde-escuro/20 bg-cream/60 px-4 py-2.5 text-foreground placeholder:text-verde-escuro/40 focus-visible:ring-2 focus-visible:ring-verde/30 focus-visible:border-verde transition-colors resize-y";

const labelClass = "text-sm font-semibold text-verde-escuro";

function SectionTitle({ number, title }: { number: string; title: string }) {
  return (
    <h3 className="text-base font-semibold text-verde mb-4 flex items-center gap-3">
      <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-verde text-amarelo text-sm font-bold">
        {number}
      </span>
      {title}
    </h3>
...
export function RevendedoresForm() {
  ...
  if (submitted) {
    return (
      <section className="w-full max-w-4xl mx-auto px-4 py-12 sm:py-16" aria-labelledby="obrigado-heading">
        <div className="bg-cream rounded-2xl p-8 sm:p-10 text-center border border-verde/20">
          <h2 id="obrigado-heading" className="text-xl font-semibold text-verde mb-4">
  ...
  return (
    <section className="w-full max-w-4xl mx-auto px-4 py-10 sm:py-12" aria-label="Questionário para revendedores Pé Direito">
      <div className="bg-verde rounded-2xl p-3 sm:p-5 sm:p-6 space-y-4 sm:space-y-5 sm:space-y-6">
        {/* Header */}
        <div className="rounded-xl bg-amarelo py-6 sm:py-8 px-6">
        ...
        <Form {...form}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className={inputClass} placeholder="Sua cidade" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className={labelClass}>Site</FormLabel>
                <FormControl>
                  <Input type="url" className={inputClass} placeholder="https://..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    <label className={cn("flex items-center gap-3 cursor-pointer rounded-lg border border-verde-escuro/20 bg-cream/60 px-4 py-2.5 transition-colors hover:border-verde-escuro/40", field.value === "fisica" && "border-verde bg-verde/5")}>
                      <RadioGroupItem value="fisica" id="forma-fisica" />
                      <span>Loja física</span>
                    </label>
                    <label className={cn("flex items-center gap-3 cursor-pointer rounded-lg border border-verde-escuro/20 bg-cream/60 px-4 py-2.5 transition-colors hover:border-verde-escuro/40", field.value === "online" && "border-verde bg-verde/5")}>
                      <RadioGroupItem value="online" id="forma-online" />
                      <span>Loja online</span>
                    </label>
                    <label className={cn("flex items-center gap-3 cursor-pointer rounded-lg border border-verde-escuro/20 bg-cream/60 px-4 py-2.5 transition-colors hover:border-verde-escuro/40", field.value === "marketplace" && "border-verde bg-verde/5")}>
                      <RadioGroupItem value="marketplace" id="forma-marketplace" />
                      <span>Marketplace</span>
                    </label>
                    <label className={cn("flex items-center gap-3 cursor-pointer rounded-lg border border-verde-escuro/20 bg-cream/60 px-4 py-2.5 transition-colors hover:border-verde-escuro/40", field.value === "porta" && "border-verde bg-verde/5")}>
                      <RadioGroupItem value="porta" id="forma-porta" />
                      <span>Porta a porta</span>
                    </label>
                    <label className={cn("flex items-center gap-3 cursor-pointer rounded-lg border border-verde-escuro/20 bg-cream/60 px-4 py-2.5 transition-colors hover:border-verde-escuro/40", field.value === "mistos" && "border-verde bg-verde/5")}>
          ...
          <div className="pt-3 flex justify-center">
            <Button
              ...
              className="rounded-full px-8 sm:px-10 py-4 sm:py-5 bg-amarelo hover:bg-amarelo/90 text-verde-escuro disabled:opacity-70 font-narrow font-semibold text-base"
            >
